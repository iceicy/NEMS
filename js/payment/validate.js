...
/*
fn validate_form_payment : เชคว่ามีการกรอกข้อมูลหรือไม่
@Author : Jiranun
@Date : June 30, 2016
...
*/
function validate_form_payment(forms){
	//console.log(forms);
 ...
 * Example: payment_call_modal("เพิ่มข้อมูล", "panel","Y")
*/
function payment_call_modal(title_modal, modal_id,flag_reset){	
 ...
 * Example: payment_confirm("คุณต้องการลบข้อมูลนี้ ?", "ลบ", function(check){
				if(check == true){
					// Statement when confirm == true    
				}				           
			});
*/
function payment_confirm(message_str,label_confirm,callback){
	 var options = {            
        message: message_str
    };
